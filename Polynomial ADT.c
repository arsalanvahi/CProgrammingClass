...
Polynomial* initializePolynomial() {   //Its job is to create an empty polynomial by initializing the head to Null. In essence,
                                        // this head is going to set by the user to the starting of the polynomial .
